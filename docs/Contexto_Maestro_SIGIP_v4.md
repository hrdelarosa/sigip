...
Las vacaciones continúan persistiendo cada día como una ocurrencia independiente. El primer periodo comprende del 1 de abril al 30 de septiembre y el segundo del 1 de octubre al 31 de marzo del año siguiente. El año de referencia de cada periodo es el año en que inicia, por lo que enero-marzo pertenecen al segundo periodo iniciado el año anterior. Cada periodo concede 10 días sin acumulación y solo está disponible después de seis meses desde la fecha de ingreso institucional. El formulario permite agregar días individualmente o expandir un rango, con exclusión de sábados y domingos por defecto y una opción explícita para incluirlos.
