...
Las vacaciones continúan persistiendo cada día como una ocurrencia independiente. El primer periodo comprende del 1 de abril al 30 de septiembre y el segundo del 1 de octubre al 31 de marzo del año siguiente. Al registrar o editar una incidencia ordinaria se seleccionan explícitamente el periodo (primero o segundo) y el año al que se cargará el consumo; ambos pueden ser anteriores al año calendario de las fechas disfrutadas y son independientes del mes o año de esas fechas. La captura permite registrar fechas históricas de cualquier año para la carga retroactiva. Si existe una asignación que cubra las fechas, se conserva esa asignación; si no existe, la incidencia puede registrarse sin asignación. Cada periodo concede 10 días sin acumulación y solo está disponible después de seis meses desde la fecha de ingreso institucional. El formulario permite agregar días individualmente o expandir un rango, con exclusión de sábados y domingos por defecto y una opción explícita para incluirlos.
